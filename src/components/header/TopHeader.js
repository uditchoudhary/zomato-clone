  ...
  return (
    <div className="container-fluid">
      <nav className="navbar row p-3">
        <div className="nav-item col-4" style={{ fontSize: "14px" }}>
          <svg
        ...
        <div className="nav-item col-4 d-flex justify-content-center">
          <Link className="text-center link-dark link-light" to="/">
            <img
              src="/images/foodgasm-logo.png"
              alt="logo"
              className="brand-logo"
            />
          </Link>
        </div>
        <div className="nav-item col-4 text-end" id="profile">
          <img
