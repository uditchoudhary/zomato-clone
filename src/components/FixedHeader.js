...
const FixedHeader = () => {
  ...
  return (
    <div className="container-fluid text-white p-0">
      <div className="header">
        <nav className="navbar row p-3">
          <div className="nav-item col-8 col-xs-6" style={{ fontSize: "14px" }}>
            <svg
            ...
            <button className="btn" id="themeButton" onClick={toggleTheme}>
              Dark Mode
            </button>
          </div>
          <div className="nav-item col-2 col-xs-6 text-end" id="add-resturants">
            Add Resturants
          </div>
          <div
    ...
    //           <path d="M18.5788 11.8561H18.3151H16.3193C15.7302 11.8561 15.251 12.3353 15.251 12.9253V13.0423C15.251 13.6329 15.7291 14.1107 16.3193 14.1107H16.5845H18.3139H18.5782C19.1693 14.1107 19.646 13.6329 19.6474 13.0423V12.9253C19.6472 12.3353 19.1705 11.8561 18.5788 11.8561Z"></path>
    //         </svg>
    //         <button onClick={toggleTheme} className="themeToggle btn btn-dark">
    //           Change theme
    //         </button>
    //       </div>
    //       <div className="nav-item col-2 col-xs-6 text-end" id="add-resturants">
